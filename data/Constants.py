...
LOOT = {
   ...
   "Silver Pen": [2,3],
   "Gold Pen": [2,3],
   "Bronze Medal": [2,3,4,5],
   "Silver Medal": [2,3,4,5],
   "Gold Medal": [2,3,4,5],
   "Bronze Pocket Watch": [4,5],
   "Silver Pocket Watch": [4,5],
   "Gold Pocket Watch": [4,5],
   "Topaz": [4,5,6,7],
   "Sapphire": [4,5,6,7],
   "Ruby": [4,5,6,7],
   "Small Nugget": [6,7,8],
   "Medium Nugget": [6,7,8],
   "Large Gold Bar": [6,7,8],
   "Small Necklace": [6,7,8],
   "Medium Necklace": [6,7,8],
   "Large Necklace": [6,7,8],
   "Small Diamond": [8],
   "Medium Diamond": [8],
   "Large Diamond": [8],
}
